...
-- Abrir live-server e compilar C (F5)
vim.keymap.set("n", "<F5>", function()
  ...
  elseif ext == "c" then
    ...
    -- Abrir novo terminal e rodar o binário
    -- Aqui usa foot, você pode trocar para outro terminal (ex: alacritty, kitty...)
    local term_cmd = string.format("foot -e %s", output_bin)
    vim.fn.jobstart(term_cmd, { detach = true })
